        ...
        <div class="content">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    ...
                    <tr>
                        <td>Geo Zone</td>
                        <td><select name="<?php echo $payment_method_name; ?>_geo_zone_id">
                            <option value="0">Alle zones</option>
                    ...
                    <tr>
                        <td>Sortering</td>
                        <td colspan="2"><input type="text" name="<?php echo $payment_method_name; ?>_sort_order" value="<?php echo $sort_order; ?>" size="1" /></td>
                    </tr>
