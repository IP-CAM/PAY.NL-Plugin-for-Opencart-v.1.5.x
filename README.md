...
With the PAY. plugin you can easily add different payment methods to your OpenCart webshop. You can go to https://www.pay.nl (Dutch) for an overview of all our features and services, you can also visit https://docs.pay.nl/plugins#opencart for more documentation of our plugin.
...
3. Click on the edit button on the previously installed payment method.
